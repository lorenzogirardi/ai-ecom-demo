...
Architettura enterprise ad alto livello che integra applicazione, CI/CD e infrastruttura AWS.

---

## 1. Vista Complessiva (C4 - Context Level)
...
flowchart TB
    ...
    subgraph ExternalSystems["Sistemi Esterni"]
...
## 2. Vista Container (C4 - Container Level)
...
## 14. Diagrammi Correlati

| Documento | Contenuto |
|-----------|-----------|
| [SEQUENCE_DIAGRAMS.md](./SEQUENCE_DIAGRAMS.md) | Flussi applicativi dettagliati |
| [GITHUB_PIPELINES.md](./GITHUB_PIPELINES.md) | Pipeline CI/CD |
| [AWS_ARCHITECTURE.md](./AWS_ARCHITECTURE.md) | Infrastruttura AWS dettagliata |
| [K8S_UPGRADE.md](./K8S_UPGRADE.md) | Upgrade EKS 1.29 → 1.32 |
| [CVE_ANALYSIS.md](./CVE_ANALYSIS.md) | Analisi vulnerabilità |

---

*Documento generato: 2025-12-31*
*Architettura: E-commerce Demo su AWS EKS*
