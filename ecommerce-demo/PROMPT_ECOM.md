# E-commerce Demo - Complete Prompt
...
**How-To Guides:**
- `UI_UX_HOWTO.md` - UI/UX patterns for professional interfaces
- `TESTING_HOWTO.md` - Testing patterns and TestFactory

**Architecture:**
- `AWS_ARCHITECTURE.md` - AWS infrastructure design
- `ENTERPRISE_ARCHITECTURE.md` - Enterprise patterns
- `SECURITY_ARCHITECTURE.md` - Security hardening
- `OBSERVABILITY_ARCHITECTURE.md` - Monitoring and tracing

**Session Recaps (Day 1-10):**
- `SESSION_01_RECAP.md` to `SESSION_10_RECAP.md`

**Technical Deep-Dives:**
- `GITHUB_PIPELINES.md` - CI/CD pipeline details
- `CLUSTER_AUTOSCALER.md` - Autoscaling configuration
- `CVE_ANALYSIS.md` - Security vulnerability analysis
- `K6_STRESS_TEST_REPORT.md` - Load testing results
- `CLOUDWATCH_STRESS_ANALYSIS.md` - Metrics correlation
- `OBSERVABILITY_ANALYSIS.md` - X-Ray and Container Insights
- `OPERATIONAL_PORTAL_ARCHITECTURE.md` - OPS workflows

**Claude Code Patterns:**
- `CLAUDE_MD_PATTERNS.md` - CLAUDE.md best practices
- `MULTI_TEAM_GUARDRAILS.md` - Team governance
- `CLAUDE_CODE_GOVERNANCE_FRAMEWORK.md` - Enterprise governance

**Original Planning:**
- `FIRST_PROMPT.md` - Original project prompt
- `REASONING_PROMPT_UI.md` - UI/UX planning session
- `ORIGINAL_IDEA.md` - Project vision and goals
